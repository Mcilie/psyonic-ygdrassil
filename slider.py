...
layout=[[sg.Text("Enter start value",font='Lucida'),
        ...
        [sg.Slider(orientation ='horizontal', key='stSlider', range=(1,100), enable_events = True),sg.Slider(orientation ='horizontal', key='endSlider',range=(1,100))],
